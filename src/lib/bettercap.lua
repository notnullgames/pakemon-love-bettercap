...
function bettercap:session(cb)
  REST.get(conf.bcurl + '/api/session', nil, cb)
end
...
function bettercap:lan(mac, cb)
  if mac then
    REST.get(conf.bcurl + '/api/session/lan/' + mac, nil, cb)
  else
    REST.get(conf.bcurl + '/api/session/lan', nil, cb)
  end
end
...
function bettercap:wifi(mac, cb)
  if mac then
    REST.get(conf.bcurl + '/api/session/wifi/' + mac, nil, cb)
  else
    REST.get(conf.bcurl + '/api/session/wifi', nil, cb)
  end
end
...
function bettercap:ble(mac, cb)
  if mac then
    REST.get(conf.bcurl + '/api/session/ble/' + mac, nil, cb)
  else
    REST.get(conf.bcurl + '/api/session/ble', nil, cb)
  end
end
...
function bettercap:hid(mac, cb)
  if mac then
    REST.get(conf.bcurl + '/api/session/hid/' + mac, nil, cb)
  else
    REST.get(conf.bcurl + '/api/session/hid', nil, cb)
  end
end
...
function bettercap:clearEvents(n, cb)
  if n then
    REST.delete(conf.bcurl + '/api/events', nil, { n = n }, cb)
  else
    REST.delete(conf.bcurl + '/api/events', nil, nil, cb)
  end
end
